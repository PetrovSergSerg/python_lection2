...
def test_edit_first_contact_from_list_to_random_parameters(app):
...
def test_edit_first_contact_from_list_to_handled_parameters(app):
    app.session.login(User.ADMIN)
    contact1 = Contact(lastname='first', firstname='contact')
    contact2 = Contact(lastname='second', firstname='contact')
    app.contact.create(contact1)
...
def test_edit_last_contact_from_list_to_random_parameters(app):
    app.session.login(User.ADMIN)
    contact1 = Contact(lastname='first', firstname='contact')
    contact2 = Contact(lastname='second', firstname='contact')
    app.contact.create(contact1)
...
def test_edit_last_contact_from_list_to_handled_parameters(app):
    app.session.login(User.ADMIN)
    contact1 = Contact(lastname='first', firstname='contact')
    contact2 = Contact(lastname='second', firstname='contact')
    app.contact.create(contact1)
